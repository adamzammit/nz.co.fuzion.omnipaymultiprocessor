...
return array(
    array(
        'name' => 'OmniPay - SecurePay SecureXML',
        'entity' => 'payment_processor_type',
        'params' => array(
            'version' => 3,
            'title' => 'OmniPay - SecurePay SecureXML',
            'name' => 'omnipay_SecurePay_SecureXML',
            'description' => 'Omnipay SecurePay - SecureXML Payment Processor',
            'user_name_label' => 'merchantId',
            'password_label' => 'transactionPassword',
            'class_name' => 'Payment_OmnipayMultiProcessor',
            'url_site_default' => 'https://api.securepay.com.au/xmlapi/payment',
            'url_api_default' => 'https://api.securepay.com.au/xmlapi/payment',
            'url_api_test_default' => 'https://test.api.securepay.com.au/xmlapi/payment',
            'url_site_test_default' => 'https://test.api.securepay.com.au/xmlapi/payment',
            'billing_mode' => 1,
            'payment_type' => 1,
        ),
    ),
